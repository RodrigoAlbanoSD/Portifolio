import Card from '../structures/cards';
import "./experiencias.css";
function Experiencias() {
   
    return <section id="experiencias" className="experiencias-section" >

        <h2 className="title">
            Minhas <span style={{ color: "rgb(16, 185, 129)" }}>Experiencias</span>
        </h2>
        ...
        <div style={{ position: "relative" }}>
            ...
            {/* divisória central */}
            <div className="divisoriaCentral"></div>
